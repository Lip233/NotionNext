...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '徐平平', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有点实力，但是不多😅', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://114514online.space', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      artist: 'Pianoboy',
      url: 'http://music.163.com/song/media/outer/url?id=410518453.mp3',
      cover: 'http://p1.music.126.net/3HT3AxHq8uXHPbFbH7Qoyw==/109951167208222169.jpg'
    }
  ],
